...
#ifndef __TINYOS__DRIVERS__FAT_H
#define __TINYOS__DRIVERS__FAT_H
...
namespace tinyos
{
    namespace filesystem
    {
        ...
        void ReadBiosBlock(tinyos::drivers::AdvancedTechnologyAttachment* hd, common::uint32_t partitionOffset);
    }
}
